...
public class NCNEXUSDXMessageListener extends AbstractSequencingMessageListener {

    private static final Logger logger = LoggerFactory.getLogger(NCNEXUSDXMessageListener.class);

    public NCNEXUSDXMessageListener() {
        super();
    }
