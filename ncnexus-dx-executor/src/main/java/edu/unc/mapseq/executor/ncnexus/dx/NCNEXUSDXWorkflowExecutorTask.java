...
import edu.unc.mapseq.workflow.ncnexus.dx.NCNEXUSDXWorkflow;

public class NCNEXUSDXWorkflowExecutorTask extends TimerTask {

    private static final Logger logger = LoggerFactory.getLogger(NCNEXUSDXWorkflowExecutorTask.class);
    ...
    public NCNEXUSDXWorkflowExecutorTask() {
        super();
    }
        ...
        try {
            ...
            if (CollectionUtils.isNotEmpty(attempts)) {
                ...
                for (WorkflowRunAttempt attempt : attempts) {
                    ...
                    NCNEXUSDXWorkflow ncGenesDXWorkflow = new NCNEXUSDXWorkflow();
                    ...
                    ncGenesDXWorkflow.setWorkflowRunAttempt(attempt);
